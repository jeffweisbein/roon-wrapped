...
const envSchema = z.object({
  ...
  ROON_WEBSITE: z.string().url().default('https://github.com/jeffweisbein/roon-wrapped'),
...
function validateEnv() {
  try {
    ...
    if (!env.LASTFM_API_KEY) {
      console.warn('[Env] LASTFM_API_KEY not configured - recommendation features will be limited');
      console.warn('[Env] Get a free API key from https://www.last.fm/api/account/create');
    }
