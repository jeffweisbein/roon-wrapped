...
function loadConfig(): Config {
  ...
  return {
    roon: {
      extension_id:
        process.env.ROON_EXTENSION_ID || fileConfig.roon.extension_id,
      display_name:
        process.env.ROON_DISPLAY_NAME || fileConfig.roon.display_name,
      display_version:
        process.env.ROON_DISPLAY_VERSION || fileConfig.roon.display_version,
    ...
    history: {
      ...
      backupPath:
        process.env.HISTORY_BACKUP_PATH || fileConfig.history.backupPath,
      backupInterval: parseInt(
        process.env.HISTORY_BACKUP_INTERVAL ||
          fileConfig.history.backupInterval,
      ),
    },
    logging: {
      ...
      maxFiles: parseInt(
        process.env.LOG_MAX_FILES || fileConfig.logging.maxFiles,
      ),
    },
  };
}
